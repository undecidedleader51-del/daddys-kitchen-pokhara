...
<body>
    ...
    <a href="https://wa.me/977984567967?text=Hello%20Daddy's%20Kitchen!%20I'd%20like%20to%20make%20a%20reservation." class="whatsapp-btn" target="_blank">
    ...
    <section id="menu" class="menu-section">
        <div class="container">
            ...
            <div class="menu-showcase">
                <div class="showcase-image showcase-left">
                    <img src="https://images.unsplash.com/photo-1621996346565-e3dbc353d2e5?w=500&h=400&fit=crop" alt="Khaja Set">
                    <div class="image-overlay">
                        <h3>Khaja Set</h3>
                    </div>
                </div>
                <div class="showcase-image showcase-right">
                    <img src="https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=500&h=400&fit=crop" alt="Tandoori Special">
                    <div class="image-overlay">
  ...
  <div cass="menu-content active" id="appetizers">
                <div class="food-grid">
                    <div class="food-card">
                        <div class="food-icon">
                        ...
                        <div class="food-info">
                            <h3>Aloo Stick</h3>
                            <div class="price-tag">Rs 60</div>
                            <p>Crispy potato sticks with authentic spices</p>
                        </div>
                    </div>
                    <div class="food-card">
                        <div class="food-icon">
                            <i class="fas fa-fries"></i>
                        </div>
                        <div class="food-info">
                            <h3>French Fries</h3>
                            <div class="price-tag">Rs 185</div>
                    ...
                    <div class="food-card">
                        ...
                        <div class="food-info">
                            ...
                            <div class="price-tag">Rs 220</div>
                    ...
                    <div class="food-card">
                        ...
                        <div class="food-info">
                            <h3>Buffalo Wings</h3>
                            <div class="price-tag">Rs 460</div>
            ...
            <div class="menu-content" id="khaja">
                <div class="food-grid">
                    <div class="food-card">
                        ...
                        <div class="food-info">
                            <h3>Veg Khaja Set</h3>
                            <div class="price-tag">Rs 320</div>
                    ...
                    <div class="food-card">
                        ...
                        <div class="food-info">
                            ...
                            <div class="price-tag">Rs 480</div>
                ...
                <div class="food-grid">
                    <div class="food-card">
                        ...
                        <div class="food-info">
                            ...
                            <div class="price-tag">Rs 420</div>
                    ...
                    <div class="food-card">
                        ...
                        <div class="food-info">
                            <h3>Chicken Curry</h3>
                            <div class="price-tag">Rs 360</div>
                ...
                <div class="food-grid">
                    <div class="food-card">
                        ...
                        <div class="food-info">
                            ...
                            <div class="price-tag">Rs 500/950</div>
                            <p>Full/Half clay oven roasted chicken</p>
                        </div>
                    </div>
                    <div class="food-card">
                        <div class="food-icon">
                            <i class="fas fa-skewer"></i>
                        </div>
                        <div class="food-info">
                            <h3>Chicken Tikka</h3>
                            <div class="price-tag">Rs 520</div>
                    ...
                    <div class="food-card">
                        ...
                        <div class="food-info">
                            <h3>Fish Tikka</h3>
                            <div class="price-tag">Rs 700</div>
        ...
        <div class="container">
            ...
            <div class="maps-container">
                ...
                <div class="contact-info">
                    ...
                    <p><i class="fas fa-phone"></i> 061-457967</p>
